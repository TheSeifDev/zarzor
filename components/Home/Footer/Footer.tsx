...
const Footer = () => {
  return (
    <footer className="bg-black">
      <section
        className="grid grid-cols-1 md:grid-cols-2 min-h-[80vh] mt-10 overflow-hidden "
      >
        {/* Left side - Text */}
        <motion.section
      ...
      {/* Bottom bar */}
      <section id="contact" className="flex items-center justify-center border-t border-gray-700 px-6 py-4 text-white text-sm">
        {/* Left */}
        ...
        <Link
          href="https://github.com/TheSeifDev"
          target="_blank"
          className="hover:text-gray-300"
        >
          Developed by TheSeifDev
        </Link>
      </section>
    </footer>
  );
